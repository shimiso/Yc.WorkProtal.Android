...
public class PaseDateUtil {
     ...
     * @param year     农历年份
     * @param month    农历月
     * @param monthDay 农历日	 * @param isLeapMonth	 *
     *                 该月是否是闰月
     ...
     * @return 返回农历日期对应的公历日期，0:year, 1:month, 2:day
     */
    public static final int[] lunarToSolar(String year, String month, String monthDay, boolean isLeapMonth) {
    ...
    public static final String solarToLunar(int year, int month, int monthDay) {
        ...
        String chinaDayString = getChinaDayString(lunarDate[2]);
        if (chinaDayString.equals("初一")) {
            return chineseNumber[lunarDate[1] - 1] + "月";
        }
