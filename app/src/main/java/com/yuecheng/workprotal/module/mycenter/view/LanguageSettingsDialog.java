...
public class LanguageSettingsDialog extends Dialog {
    ...
    public LanguageSettingsDialog(@NonNull Context context) {
        super(context);
        init();
    }

    public LanguageSettingsDialog(@NonNull Context context, int themeResId) {
        super(context, themeResId);
        init();
    }

    protected LanguageSettingsDialog(@NonNull Context context, boolean cancelable, @Nullable OnCancelListener cancelListener) {
