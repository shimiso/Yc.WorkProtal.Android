package com.yuecheng.workprotal.mywork.editor;
...
public class EditorApplicationActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_editor_application);
        ...
        functionAdapter.setOnItemAddListener(new FunctionAdapter.OnItemAddListener() {
            ...
            public boolean add(FunctionItem item) {
                if (selData != null && selData.size() < MAX_COUNT) {   // 更新选择列表，所有列表已在内部进行更新
                    ...
                    Toast.makeText(EditorApplicationActivity.this,"选中的模块不能超过"+MAX_COUNT+"个",Toast.LENGTH_SHORT).show();
                    return false;
                }
            }
        });
