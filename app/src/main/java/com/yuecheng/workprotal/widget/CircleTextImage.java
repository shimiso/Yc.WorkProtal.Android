package com.yuecheng.workprotal.widget;
...
public class CircleTextImage extends ImageView {
    ...
    private float mCircletTextSize = 18;//Is whether intercept first character
...
//    private static final float DEFAULT_TEXT_SIZE_RATIO = 0.2f;
//    private float textSizeRatio = DEFAULT_TEXT_SIZE_RATIO;
    ...
    private void initAttr(Context context, AttributeSet attrs) {
        ...
        mCircletTextSize = typedArray.getDimension(R.styleable.circletextview_circle_text_size,18);
...
//            mPaintTextForeground.setTextSize(textSizeRatio * 2 * 100);//adapt some telphone
            mPaintTextForeground.setTextSize(mCircletTextSize);//adapt some telphone
    ...
    private void refreshTextSizeConfig() {
        mPaintTextForeground.setTextSize(mCircletTextSize);
