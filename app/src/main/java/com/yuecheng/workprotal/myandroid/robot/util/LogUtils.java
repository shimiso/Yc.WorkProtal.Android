package com.yuecheng.workprotal.myandroid.robot.util;
...
public class LogUtils {
    ...
    public static void init(boolean logSwitch, boolean log2FileSwitch, char logFilter, String tag) {
        if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())) {
            dir = VRApplication.getApplication().getExternalCacheDir().getPath() + File.separator;
        } else {
            dir = VRApplication.getApplication().getCacheDir().getPath() + File.separator;
        }
    ...
    public static Builder getBuilder() {
        if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())) {
            dir = VRApplication.getApplication().getExternalCacheDir().getPath() + File.separator + "log" + File.separator;
        } else {
            dir = VRApplication.getApplication().getCacheDir().getPath() + File.separator + "log" + File.separator;
        }
        return new Builder();
    }
