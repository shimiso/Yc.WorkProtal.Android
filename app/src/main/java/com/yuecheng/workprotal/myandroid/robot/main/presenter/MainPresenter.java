...
import com.yuecheng.workprotal.myandroid.robot.bean.DateBean;
import com.yuecheng.workprotal.myandroid.robot.bean.LocationBean;
import com.yuecheng.workprotal.myandroid.robot.bean.MusicBean;
import com.yuecheng.workprotal.myandroid.robot.bean.SemanticBean;
import com.yuecheng.workprotal.myandroid.robot.bean.SemanticComprehensionResult;
import com.yuecheng.workprotal.myandroid.robot.bean.SlotsBean;
import com.yuecheng.workprotal.myandroid.robot.bean.TalkBean;
import com.yuecheng.workprotal.myandroid.robot.bean.WeatherBean;
import com.yuecheng.workprotal.myandroid.robot.main.adapter.TalkListAdapter;
import com.yuecheng.workprotal.myandroid.robot.main.model.IMainModel;
import com.yuecheng.workprotal.myandroid.robot.main.model.MainModel;
import com.yuecheng.workprotal.myandroid.robot.main.service.MusicService;
import com.yuecheng.workprotal.myandroid.robot.main.view.IMainView;
import com.yuecheng.workprotal.myandroid.robot.util.DeviceUtils;
import com.yuecheng.workprotal.myandroid.robot.util.LogUtils;
import com.yuecheng.workprotal.myandroid.robot.util.SpUtils;
import com.yuecheng.workprotal.myandroid.robot.util.StringUtils;
